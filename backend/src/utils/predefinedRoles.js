...
// Legacy hardcoded recommendations are intentionally kept in the file
// for reference but are NOT exported. The application now prefers
// dynamic recommendations generated by an LLM (Gemini). If the LLM is
// unavailable the skill-gap route will fall back to a short auto-generated
// message per missing skill.
...
module.exports = { PREDEFINED, findRoleKey };
